...
import logic.City;
import logic.Nationality;
import logic.Passport;
import logic.Person;
...
public class PersonService {
    ...
    public Person setPerson() {
        Person p = new Person();
        Scanner scanner = new Scanner(System.in);//сканер для считывания данных с консоли
        while (true) {
            try {
    ...
    private Nationality setNationality() {//добавление национальности пользователю
